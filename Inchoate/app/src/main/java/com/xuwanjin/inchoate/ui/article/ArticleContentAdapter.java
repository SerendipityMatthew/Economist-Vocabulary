...
public class ArticleContentAdapter extends RecyclerView.Adapter<ArticleParagraphViewHolder> {
    ...
    @NonNull
    @Override
    public ArticleParagraphViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        switch (viewType) {
            case TYPE_FOOTER:
                view = mFooterView;
        ...
        if (view == mFooterView || view == mHeaderView){
            return new ArticleParagraphViewHolder(view, mContext, mArticle, true);
        }
        return new ArticleParagraphViewHolder(view, mContext, mArticle, false);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull ArticleParagraphViewHolder holder, int position) {
